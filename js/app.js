...
function setupAuthForms() {
    ...
    if (!tabBtns.length || !formContainer) return;
    ...
    function renderAuthForm(isLoginForm) {
        if (isLoginForm) {
            formContainer.innerHTML = `
                <div class="form-group">
                    <label class="form-label">Email Address</label>
                    <input type="email" class="form-input" placeholder="name@email.com" id="email">
                </div>
                <div class="form-group">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                        <label class="form-label" style="margin-bottom: 0;">Password</label>
                        <a href="#" style="color: var(--accent-primary); font-size: 12px; font-weight: 600; text-decoration: none;" onclick="showDevModal(); return false;">Forgot?</a>
                    </div>
                    <input type="password" class="form-input" placeholder="••••••••••••" id="password">
                </div>
                <button class="btn-submit" id="authSubmit">Access Dashboard</button>
                <div class="divider">or continue with</div>
                <div class="oauth-grid">
                    <div class="oauth-btn" onclick="showDevModal()">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12.48 10.92v3.28h7.84c-.24 1.84-.908 3.152-1.928 4.176-1.224 1.224-3.136 2.52-6.52 2.52-5.416 0-9.696-4.384-9.696-9.8s4.28-9.8 9.696-9.8c2.936 0 5.144 1.152 6.704 2.624l2.32-2.32c-1.968-1.88-4.512-3.328-9.024-3.328-7.96 0-14.48 6.52-14.48 14.48s6.52 14.48 14.48 14.48c4.224 0 7.408-1.392 9.824-3.92 2.496-2.496 3.272-5.992 3.272-8.736 0-.824-.064-1.608-.192-2.32h-12.912z"></path></svg>
                        Google
                    </div>
                    <div class="oauth-btn" onclick="showDevModal()">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.477 2 2 6.477 2 12c0 4.418 2.865 8.166 6.839 9.489.5.092.682-.217.682-.482 0-.237-.008-.866-.013-1.7-2.782.603-3.369-1.341-3.369-1.341-.454-1.152-1.11-1.459-1.11-1.459-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.294 2.747-1.025 2.747-1.025.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12c0-5.523-4.477-10-10-10z"></path></svg>
                        GitHub
                    </div>
                </div>
                <div style="margin-top: 32px; text-align: center; font-size: 13px; color: var(--text-tertiary);">
                    By continuing, you agree to our <a href="#" style="color: var(--text-secondary); text-decoration: none;" onclick="showDevModal(); return false;">Terms of Service</a> and <a href="#" style="color: var(--text-secondary); text-decoration: none;" onclick="showDevModal(); return false;">Privacy Policy</a>.
                </div>
            `;
        } else {
            formContainer.innerHTML = `
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" placeholder="John Doe" id="fullName">
                </div>
                <div class="form-group">
                    <label class="form-label">Email Address</label>
                    <input type="email" class="form-input" placeholder="name@email.com" id="email">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" class="form-input" placeholder="+1 (555) 000-0000" id="phone">
                </div>
                <div class="form-group">
                    <label class="form-label">Password</label>
                    <input type="password" class="form-input" placeholder="••••••••••••" id="password">
                </div>
                <button class="btn-submit" id="authSubmit">Create Account</button>
                <div style="margin-top: 24px; text-align: center; font-size: 13px; color: var(--text-tertiary);">
                    By registering, you agree to our <a href="#" style="color: var(--text-secondary); text-decoration: none;" onclick="showDevModal(); return false;">Terms of Service</a> and <a href="#" style="color: var(--text-secondary); text-decoration: none;" onclick="showDevModal(); return false;">Privacy Policy</a>.
                </div>
            `;
        }

        setupAuthSubmit(isLoginForm);
    }

    function setupAuthSubmit(isLoginForm) {
        ...
        submitBtn.addEventListener('click', async (e) => {
            ...
            try {
                ...
                submitBtn.disabled = false;
                submitBtn.textContent = isLoginForm ? 'Access Dashboard' : 'Create Account';
            }
        });
    }
}
